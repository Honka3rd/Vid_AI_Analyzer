...
(function() {
  ...
  var Hosts;
  ((Hosts2) => {
    Hosts2.YOUTUBE = "youtube.com/watch";
  })(Hosts || (Hosts = {}));
  const _YTTranscriptExtractor = class _YTTranscriptExtractor {
    constructor() {
      __publicField(this, "id", Hosts.YOUTUBE);
    ...
    getContainer() {
      ...
      this.container = document.querySelector(_YTTranscriptExtractor.CONTAINER_ID);
      return this.container;
    }
    texts(container) {
      if (!container) {
      ...
      return {
        ...
        lines: segments.map((s) => {
          var _a;
          return (_a = s.textContent) == null ? void 0 : _a.trim();
        }).filter((s) => !lodashExports.isEmpty(s))
      };
    }
    waitTargetMount() {
    ...
    captions() {
      if (this.subject) {
        return lodashExports.clone(this.subject.value);
      }
      return {
        time: Date.now(),
        lines: []
  ...
  const _Resolver = class _Resolver {
    constructor() {
      __publicField(this, "mapper", /* @__PURE__ */ new Map([
    ...
    resolve(url) {
      var _a;
      if (lodashExports.isEmpty(url)) {
        return null;
      }
      const factory = (_a = Array.from(this.mapper.entries()).find(
        ([k]) => this.match(url, k)
      )) == null ? void 0 : _a[1];
      return factory ? factory() : null;
    }
  };
  __publicField(_Resolver, "singleton", lodashExports.memoize(() => new _Resolver()));
